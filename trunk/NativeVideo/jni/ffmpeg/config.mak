...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-cross-compile --arch=arm --target-os=linux --disable-debug --disable-stripping --enable-pthreads --enable-nonfree --disable-yasm --disable-inline-asm --enable-avdevice --disable-doc --enable-avfilter --prefix=../output --enable-version3 --disable-shared --disable-symver --enable-static --enable-gpl --enable-small --enable-memalign-hack --cc=arm-linux-androideabi-gcc --ld=arm-linux-androideabi-gcc --extra-cflags='-fPIC -DANDROID -D__thumb__ -mthumb -Wfatal-errors -Wno-deprecated -DHAVE_CBRT' --disable-protocol=rtmp --disable-protocol=rtmps --disable-protocol=rtmpt --disable-protocol=rtmpe --disable-protocol=rtmpte --extra-cflags=-Ivideokit
prefix=../output
...
NOREDZONE_FLAGS=
libavcodec_VERSION=55.6.100
libavcodec_VERSION_MAJOR=55
libavcodec_VERSION_MINOR=6
libavdevice_VERSION=55.0.100
libavdevice_VERSION_MAJOR=55
libavdevice_VERSION_MINOR=0
libavfilter_VERSION=3.62.100
libavfilter_VERSION_MAJOR=3
libavfilter_VERSION_MINOR=62
libavformat_VERSION=55.4.100
